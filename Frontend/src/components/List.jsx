...
const ListPassenger = () => {
    ...
    for (let i = 0; i < length; i++) {
        ...
        MyArr.push(<tr key={i}>
            ...
            <td>
                <button className="button buttonSupport" onClick={() => { handleUpdate(element.passenger_id) }}>Update</button>
                <button className="button buttonSupport" onClick={() => { handleDelete(element.passenger_id) }}>Delete</button>
            </td>
        </tr>)
    }
...
const ListBus = () => {
    ...
    for (let i = 0; i < length; i++) {
        ...
        MyArr.push(<tr key={i}>
            ...
            <td>
                <button className="button buttonSupport" onClick={() => { handleUpdate(element.bus_id) }}>Update</button>
                <button className="button buttonSupport" onClick={() => { handleDelete(element.bus_id) }}>Delete</button>
            </td>
        </tr>)
    }
...
const ListRoute = () => {
    ...
    for (let i = 0; i < length; i++) {
        ...
        MyArr.push(<tr key={i}>
            ...
            <td>
                <button className="button buttonSupport" onClick={() => { handleUpdate(element.routeInfo_id) }}>Update</button>
                <button className="button buttonSupport" onClick={() => { handleDelete(element.routeInfo_id) }}>Delete</button>
            </td>
        </tr>)
    }
...
const ListBookingInfo = () => {
    ...
    for (let i = 0; i < length; i++) {
        ...
        MyArr.push(<tr key={i}>
            ...
            <td>{format(element?.boardingDateTime, "dd-MM-yyy hh:mm")}</td>
            <td>{format(element?.droppingDateTime, "dd-MM-yyy hh:mm")}</td>
            <td>
                <button className="button buttonSupport" onClick={() => { handleDelete(element.bookingInfo_id) }}>Delete</button>
            </td>
        </tr>)
    }
